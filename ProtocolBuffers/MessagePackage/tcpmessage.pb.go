...
const (
	...
	MsgType_GET_MASTER       MsgType = 4 // Get request send to master
	MsgType_GET_MASTER_REP   MsgType = 5 // Master reply to get request, send back target ip
	MsgType_GET_P2P          MsgType = 6 // Get request send to target ip
	MsgType_GET_P2P_ACK      MsgType = 7 // Target ip send back ack (may require to tell back file size)
	MsgType_GET_P2P_SIZE_ACK MsgType = 8 // The get request initiator tell file source ip that it get the file size info successfully, once this is received, start sending file
	MsgType_REPLICA          MsgType = 9
	MsgType_WRITE_ACK        MsgType = 10 // when finish write, send ACK to client
	MsgType_READ_ACK         MsgType = 11 // when finish read, send ACK to client
	MsgType_DELETE           MsgType = 12 // master send delete request to file node
	MsgType_DELETE_ACK       MsgType = 13 // server reply to DELETE message
	MsgType_LIST             MsgType = 14 // client send LIST request to master,
	MsgType_LIST_REP         MsgType = 15 // master send sdfsfilename list to server
)
...
var file_tcpmessage_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x50, 0x61, 0x74, 0x68, 0x2a, 0x81,
	0x02, 0x0a, 0x07, 0x4d, 0x73, 0x67, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0e, 0x0a, 0x0a, 0x50, 0x55,
	...
	,
